                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-bold text-uppercase">Type</th>
                                    ...
                                    @foreach ($customers as $key => $customer)
                                        <tr>
                                            ...
                                            <td>
                                                @if(($customer->getRoleNames()->count()))
                                                    @foreach($customer->getRoleNames() as $v)
                                                        <label class="label label-success text-capitalize">{{ $v }}</label>
                                                    @endforeach
                                                @else
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary fa fa-edit" href="{{ route('edit',$customer->id) }}" title="Edit"></a>
                                                <a class="btn btn-sm btn-info fa fa-eye" href="{{ route('show',$customer->id) }}" title="Show"></a>
{{--                                                @can('delete')--}}
{{--                                                    <button title="Delete" class="btn btn-sm btn-danger bold uppercase delete_button" data-toggle="modal" data-target="#DelModal" data-id="{{ $customer->id }}">--}}
