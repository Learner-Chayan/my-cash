    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('home-notification.update', $notification->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="title" value="{{$notification->title}}" required  placeholder="Title">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Description <code>*</code></label>
                                    <textarea class="form-control" id="summernote" name="description">{!! $notification->description !!}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 180px; height: 180px; padding: 0px;" data-trigger="fileinput">
                                                ...
                                                <img style="width: 180px" src="{{$image}}" alt="Please Select Your Image......">
                                            </div>
